...
// seleção pelos ids, os campos da página
...
button.addEventListener('click', (event) => {
  // usar o preventDefault() para evitar que, ao
  // clicar no botão, ele recarregue a página
  event.preventDefault();

  // Aqui, criei um objeto cujas chaves são os tipos a
  ...
  textoDeSaida.innerHTML = `A validação deu ${campos[seletor.value]}`;
});
